...
/**
 * Get total likes for a junction (base + local likes).
 */
...
/**
 * Check if a junction is installed.
 */
...
/**
 * Create a custom junction from user input.
 */
...
/**
 * Publish a junction for community review (mock — saves to localStorage).
 */
...
/**
 * Get published junctions by the local user.
 */

...
- [x] [P4-102] Duolingo-style daily reward chest animation — ✅ DONE — Commit: dc98c57 — v1.19.84 — DailyRewardToast expanded from 130→731 lines. 4-tier chest system (Bronze 1-6d, Silver 7-13d, Gold 14-29d, Diamond 30+d) with CSS keyframe animations (chest-bounce, chest-glow-pulse, chest-particle-burst, chest-lid-lift, chest-light-burst, chest-fly-up, chest-xp-pop). State machine: idle→opening→revealed→claimed. Tier-based bonus XP (0/25/50/100). XP counter counting animation.
